...
label_to_color_map = {
    'BBR':        (0.36, 0.54, 0.66),
    #'BBR/BBR2':  (0.0, 1.0, 1.0),
    'RENO/CUBIC':       (0.53, 0.66, 0.42),
    #'BBR/BBR2':      (1.0, 0.44, 0.37),
    #'RENO/CUBIC': (0.71, 0.65, 0.26),
    #'BBR/BBR2': (0.59, 0.29, 0.0),
    'BBR/RENO':   (0.74, 0.2, 0.64),
    'BBR/CUBIC':  (0.44, 0.16, 0.39),
    #'BBR/BBR2':   (0.16, 0.44, 0.39),
    'BBR2':      (0.89, 0.61, 0.06),
    'BBR2/RENO':        (0.52, 0.39, 0.44),
    #'BBR2/CUBIC':    (0.52, 0.39, 0.44),
    #'BBR/BBR2':    (0.91, 0.17, 0.31),
    #'BBR/BBR2':   (1.00, 0.75, 0.00),
    'BBR2/CUBIC':     (0.56, 0.74, 0.86),
    #'BBR/BBR2':   (0.53, 0.66, 0.42),
    #'BBR/BBR2':  (0.89, 0.61, 0.06),
    #'BBR/BBR2':    (0.36, 0.54, 0.66),
    'BBR/BBR2':  (0.91, 0.17, 0.31),
...
def plot_metric(plot_handle, data_source, data_frame, x_param, y_param, z_param, other_params, plot_config):
    ...
    z_param_values = [z for z in z_param_values if z != "CUBIC/RENO"]
